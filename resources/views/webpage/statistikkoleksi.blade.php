      ...
      <div class="row row-80">
        <div class="col-lg-7 col-xl-8 section-divided__main">
          <div class="section-sm">
              ...
              <div class="container" >
                <div class="row">
                  <div class="col-sm-12 text-center">
                    <h4 class="heading-decorated">Statistik Koleksi</h4>
                  </div>
                </div>
            ...
            <form class="rd-search text-center" action="/koleksi/download" method="GET" data-search-live="rd-search-results-live">
            ...
            <form class="rd-search" action="" method="GET" data-search-live="rd-search-results-live">
              <div class="form-wrap form-wrap_icon">
                <select name='type' class="form-input">
                  ...
                  @if($type=='worksheet') 
                  selected @endif>Worksheet</option>
                </select>
              </div>
              <div class="form-wrap form-wrap_icon ">
                <label>From :</label>
